...
if __name__ == "__main__":
    ...
    uc = model.get_learned_conditioning( ["unrealistic, blurry, low quality, out of focus, ugly, low contrast, dull, low-resolution, oversaturation."] ).to(device)
    ...
    images = []
    for j in range(3):
        img = t2i(model, args.size, t, uc, sampler, step=500, scale=10, batch_size=batch_size, ddim_eta=0.0, 
